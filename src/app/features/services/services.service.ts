  ...
  get cards(): { [key: string]: ServicesCard } {
    return {
      left: {
        ...
        icon: 'images/iot-1.svg',
        noun: 'https://thenounproject.com/icon/noun-iot-7063138/',
      },
      right: {
        ...
        noun: 'https://thenounproject.com/icon/consult-6404230/',
      },
      front: {
        id: 'custom-web-dev',
        ...
        noun: 'https://thenounproject.com/icon/noun-web-7046500/',
      },
      top: {
        ...
        noun: 'https://thenounproject.com/icon/noun-b2b-5940310/',
      },
      bottom: {
        ...
        noun: 'https://thenounproject.com/icon/search-7032534/',
      },
      back: {
        id: 'tutoring',
        ...
        noun: 'https://thenounproject.com/icon/noun-graduate-6694848.svg/',
      },
    };
  }
}
